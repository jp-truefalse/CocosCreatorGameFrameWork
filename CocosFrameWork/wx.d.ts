...
interface onShareAppMessageOpts{
	/**
	 * 转发标题
	 */
	title:string;
...
interface OpenInterfaceAPIs {
	 ...
	 * 监听左上角转发到朋友圈按钮的触发事件
	 */
	onShareTimeline:(callback:()=>onShareTimelineOpts)=>void;
	/**
	 * 监听右上角转发按钮按钮触发事件
	 */
	onShareAppMessage:(callback:()=>onShareAppMessageOpts)=>void
	/**
	 * 获取转发详细信息
	 */
